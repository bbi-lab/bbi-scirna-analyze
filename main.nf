...
fastq_demux = Channel.fromPath("$demux_out/*.bam")
...
workflow {
  ...
  **      params.object_map.merge_bam_map.
  **   o  the function align_bams_function(item) uses
  ...
  **      operator calles align_bams_function() and
  ...
  */
  ...
  make_star_align_json.out.splitJson().map{align_bams_function(it)}.set{align_bam_channel_in}
