...
prg_exe="/home/brent/git/bbi-scirna-analyze/src/process_hashes/target/release/process_hashes"
...
# $prg_exe -s $root_dir/timecourse_hash2.txt -b $root_dir/demux_out/SeahubZ01.fq.part1-L001.bam -k foop -n SeahubZ01
$prg_exe -s $root_dir/timecourse_hash2.txt -b $root_dir/demux_out/*.bam -k foop -n SeahubZ01 -t 2
